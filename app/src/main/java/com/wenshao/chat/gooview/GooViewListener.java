...
import com.wenshao.chat.gooview.GooView.OnDisappearListener;
...
public class GooViewListener implements OnTouchListener, OnDisappearListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            mGooView.setStatusBarHeight(GooViewUtils.getStatusBarHeight(v));
    ...
    public void onDisappear(PointF mDragCenter) {
        if (mWm != null && mGooView.getParent() != null) {
            ...
            bubbleLayout.setCenter((int) mDragCenter.x, (int) mDragCenter.y - GooViewUtils.getStatusBarHeight(mGooView));
