package com.wenshao.chat.gooview;
...
import com.wenshao.chat.util.GeometryUtils;
...
public class GooView extends View {
    ...
    private void init(Context context) {
        stickCircleRadius = GooViewUtils.dip2Dimension(10.0f, context);
        dragCircleRadius = GooViewUtils.dip2Dimension(10.0f, context);
        stickCircleMinRadius = GooViewUtils.dip2Dimension(3.0f, context);
        mMaxDistance = GooViewUtils.dip2Dimension(70.0f, context);
        mResetDistance = GooViewUtils.dip2Dimension(40.0f, getContext());
